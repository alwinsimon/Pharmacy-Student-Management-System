 ...
 *         schema:
 *           type: string
 *           enum: [super_admin, manager, staff, student]
 *         description: Filter by role
 *       - in: query
 *         name: status
 *         schema:
 *           type: string
 *           enum: [pending, verified, active, inactive, suspended, deleted]
 ...
 *                 items:
 *                   type: string
 *                 example: ["user_read", "case_read", "document_read"]
 *     responses:
 *       200:
 ...
 *                   $ref: '#/components/schemas/User'
 *       400:
 *         description: User is not in verification state
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *               reason:
 *                 type: string
 *                 example: Information provided does not match our records
 *     responses:
 *       200:
 ...
 *                         path:
 *                           type: string
 *                           example: profiles/abc123-1234567890.jpg
 *                         contentType:
 *                           type: string
 *                           example: image/jpeg
 *                         uploadedAt:
 ...
 *       400:
 *         description: Profile picture is required or invalid format
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
